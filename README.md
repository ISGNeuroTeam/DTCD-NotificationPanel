# DTCD-NotificationPanel

Core system-plugin (part of DTCD-SDK) for notifications in [DTCD](https://github.com/ISGNeuroTeam/DTCD) application.
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/ISGNeuroTeam/DTCD-NotificationPanel/tags).
